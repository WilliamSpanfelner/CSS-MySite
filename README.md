![Screenshot](day-44-CSS-MySite.png)
# A more sophisticated CV site exploiting the use of HTML and CSS
...
- 🧑‍💻 This CV site is part of an introduction to web development using HTML and CSS.
